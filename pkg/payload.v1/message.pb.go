...
func (x *PayloadMessage) GetValue() int32 {
	if x != nil {
		return x.Value
	}
	return 0
...
func (x *PayloadMessage) GetFirstName() string {
	if x != nil {
		return x.FirstName
	}
	return ""
...
func (x *PayloadMessage) GetLastname() string {
	if x != nil {
		return x.Lastname
	}
	return ""
...
func (x *PayloadMessage) GetJob() string {
	if x != nil {
		return x.Job
	}
	return ""
...
func (x *PayloadMessage) GetEmail() string {
	if x != nil {
		return x.Email
	}
	return ""
...
func (x *PayloadMessage) GetDescription() string {
	if x != nil {
...
var file_proto_message_proto_rawDesc = []byte{
	...
	0x31, 0x22, 0xaa, 0x01, 0x0a, 0x0e, 0x50, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x4d, 0x65, 0x73,
	0x73, 0x61, 0x67, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x05, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x1c, 0x0a, 0x09, 0x66, 0x69,
	...
	0x6e, 0x61, 0x6d, 0x65, 0x12, 0x10, 0x0a, 0x03, 0x6a, 0x6f, 0x62, 0x18, 0x04, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x03, 0x6a, 0x6f, 0x62, 0x12, 0x14, 0x0a, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x18,
	...
	0x5a, 0x10, 0x2e, 0x2f, 0x70, 0x6b, 0x67, 0x2f, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x2e,
...
var file_proto_message_proto_goTypes = []interface{}{
	(*PayloadMessage)(nil), // 0: payload.v1.PayloadMessage
}
